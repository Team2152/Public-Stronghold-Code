...
public class Gain {
	...
	public final static double DEFAULT_DEADBAND = 0.10;      //Suited to drive train, but not necessarily other types of motor/servos
	...
	public double applyGain(double value) {
		...
		if (absVal < deadBand)
			...
			gain = SmartDashboard.getNumber("Drive Train Gain", gain);
		    return (value * gain);
		}
	}
}
